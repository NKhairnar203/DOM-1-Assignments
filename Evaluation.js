function Student(name, roll_no, _class, section, marks_of_5_subjects) {
    ...
    this.printReportCard = function () {
        ...
        console.log("+--------------------+");
        console.log(`| Name     - ${this.name.padEnd(8)}|`);
        console.log(`| Roll no. - ${this.roll_no.toString().padEnd(7)} |`);
        console.log(`| Class    - ${this.class.padEnd(7)} |`);
        console.log(`| Section  - ${this.section.padEnd(7)} |`);
        for (const subject in this.marks_of_5_subjects) {
            console.log(`| ${subject.padEnd(10)} - ${this.marks_of_5_subjects[subject].toString().padEnd(5)} |`);
        }
